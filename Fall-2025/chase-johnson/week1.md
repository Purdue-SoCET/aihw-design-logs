...
## Goals: 
Want to implement and verify the vector core functional units. Implement and verify the vector core register file. Implement and verify the vector core functionality. Integrate the vector core with other components and verify functionality.
...
Weeks 9-12  - Synthesis and Optimize Design to m`eet clock requirements.
