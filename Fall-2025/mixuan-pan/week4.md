...
3. Join the other group to figure out the convolution mapping (will take most of the time) 
4. Implement the control unit that integrates the wallace tree multiplier and the systolic array (shouldn't be complicated once we figure out the array size we're using in step 3. 
