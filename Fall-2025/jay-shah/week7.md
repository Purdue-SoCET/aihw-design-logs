...
3. Discussion with Sooraj on how to architect the scheduler pipeline. Following points were agreed upon:
   ...
   - This method can also make use of an issue queue. If we have multiple packets arriving, it's possible that packets 2 and 3 are dependent on packet 1, but packet 4 in independent. A CAM issue queue will allow us to issue packet 4 whicle keeping packets 2 and 3 in the queue. We don't need as big a CAM as a standard OOO processor, because again the parallelism in ML workloads will help us to minimize dependent packets.
