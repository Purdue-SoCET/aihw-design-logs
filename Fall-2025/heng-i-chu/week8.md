...
- **Packetization Research:**
  ...
  - Built a conceptual framework for representing dependencies as a DAG, where each instruction is a node and edges represent dependencies.
...
- **Vectorization Background Study:**
  - Studied modern SIMD and vector ISA models SSE, AVX, AVX2, and AVX-512.
